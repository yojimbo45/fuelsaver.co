...
import 'trip_place_input.dart';
import 'trip_results_widget.dart';
import 'vehicle_selector_widget.dart';

const _darkBg = Color(0xFF1D212C);

class TripPlanningSheet extends ConsumerStatefulWidget {
  const TripPlanningSheet({super.key});

  @override
  ConsumerState<TripPlanningSheet> createState() => _TripPlanningSheetState();
}

class _TripPlanningSheetState extends ConsumerState<TripPlanningSheet> {
      ...
      builder: (context, scrollController) {
        return Container(
          ...
          child: _showVehiclePanel
              ...
              : _buildMainPanel(scrollController, tripState, notifier),
        );
      },
    );
  }
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: VehicleSelectorWidget(onSelect: _handleVehicleSelect),
          ),
        ),
      ],
    );
                        ...
                        children: [
                          Expanded(
                            child: TripPlaceInput(
                              ...
                              onClear: () => notifier.updateWaypoint(i, null),
                            ),
                          ),
                          IconButton(
